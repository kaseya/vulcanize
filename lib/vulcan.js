...
var Vulcan = function Vulcan(opts) {
  ...
  this.cssUrlPrefix = (String(opts.cssUrlPrefix) === opts.cssUrlPrefix && String(opts.cssUrlPrefix).trim() !== '') ? opts.cssUrlPrefix : null;
  this.pathResolver = new PathResolver(this.abspath, this.cssUrlPrefix);
